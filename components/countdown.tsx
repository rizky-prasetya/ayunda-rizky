    ...
    return (
        <div className="flex items-center justify-center space-x-4 mt-4">
            <div className="flex flex-col items-center px-4">
                <span className="text-4xl lg:text-5xl text-gray-200">{days}</span>
                <span className="text-gray-400 mt-2">Hari</span>
            </div>
            <span className="w-[1px] h-24 bg-gray-400"></span>
            <div className="flex flex-col items-center px-4">
                <span className="text-4xl lg:text-5xl text-gray-200">{hours}</span>
                <span className="text-gray-400 mt-2">Jam</span>
            </div>
            <span className="w-[1px] h-24 bg-gray-400"></span>
            <div className="flex flex-col items-center px-4">
                <span className="text-4xl lg:text-5xl text-gray-200">{minutes}</span>
                <span className="text-gray-400 mt-2">Menit</span>
            </div>
            <span className="w-[1px] h-24 bg-gray-400"></span>
            <div className="flex flex-col items-center px-4">
                <span className="text-4xl lg:text-5xl text-gray-200">{seconds}</span>
